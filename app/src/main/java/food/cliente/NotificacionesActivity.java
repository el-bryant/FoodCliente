...
public class NotificacionesActivity extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        fab.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent = new Intent(NotificacionesActivity.this, CarritoActivity.class);
                startActivity(intent);
            }
        });
    }
    ...
    public void onBackPressed() {
        ...
        if (drawer.isDrawerOpen(GravityCompat.START)) {
            ...
            Intent intent = new Intent(NotificacionesActivity.this, CategoriaActivity.class);
            startActivity(intent);
            finish();
        }
    }
