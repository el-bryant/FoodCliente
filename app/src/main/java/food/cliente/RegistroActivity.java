...
public class RegistroActivity extends AppCompatActivity {
                ...
                runOnUiThread(new Runnable() {
                    ...
                    public void run() {
                        ...
                        if (r > 0) {
                            ...
                            Toast.makeText(RegistroActivity.this, "Gracias por su registro, activaremos su cuenta en breve",
    ...
    public void comprobardatos(final String dni) {
        ...
        final Thread tr = new Thread() {
            @Override
            public void run() {
                final String result = Funciones.primero("http://bootcampdojo.com/consulta_dni.php?documento=" + dni);
